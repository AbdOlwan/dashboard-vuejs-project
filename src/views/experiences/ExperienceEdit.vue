    ...
    <div v-else class="form-section">
      <form @submit.prevent="handleSubmit" class="experience-form">
        <div class="form-group">
          ...
          <input type="text" v-model="form.position" class="form-input" required />
        </div>

        <div class="form-group">
          <label class="form-label">اسم الشركة <span class="required">*</span></label>
          <input type="text" v-model="form.companyName" class="form-input" required />
        </div>

        <div class="form-group">
          <label class="form-label">الموقع <span class="required">*</span></label>
          <input type="text" v-model="form.location" class="form-input" required />
        </div>
        ...
        <div class="form-actions">
          ...
          <button type="button" @click="handleDelete" class="delete-btn">حذف الخبرة</button>
        </div>
      </form>

       <div class="preview-section">
        <h3 class="preview-title">معاينة بعد التعديل</h3>
...
<style scoped>
/* Styles are identical to Create and List to maintain consistency */
...
.form-input:focus, .form-textarea:focus { border-color: #4facfe; outline: none; }
...
.cancel-btn { padding: 12px 24px; background: #f3f4f6; color: #4b5563; border-radius: 8px; text-decoration: none; font-weight: 600; display: flex; align-items: center; }
.delete-btn { padding: 12px 24px; background: #fef2f2; color: #dc2626; border: 1px solid #fca5a5; border-radius: 8px; font-weight: 600; cursor: pointer; }
.delete-btn:hover { background: #fee2e2; }

/* Preview Card (Simplified for Edit) */
...
.preview-card { background: white; border-radius: 12px; padding: 24px; border: 1px solid #e5e7eb; }
