    ...
    <div class="header-section">
      ...
      <div class="header-content">
        ...
        <div>
          ...
          <p class="page-subtitle">قم بتحديث تفاصيل المهارة الحالية</p>
        </div>
      </div>
    </div>
      ...
      <div class="form-section">
        <div class="section-header">
          ...
          <div>
            ...
            <p class="section-subtitle">قم بتحديث اسم المهارة وتصنيفها</p>
          </div>
        </div>
...
onMounted(async () => {
  ...
  try {
    ...
    if (skill) {
      // ✅ تعيين القيم مع مراعاة حساسية الأحرف (camelCase من API)
      formData.name = skill.name || skill.Name;
      formData.category = skill.category || skill.Category;
      formData.displayOrder = skill.displayOrder || skill.DisplayOrder || 0;
      formData.iconUrl = skill.iconUrl || skill.IconUrl || '';
      formData.isActive = skill.isActive !== undefined ? skill.isActive : skill.IsActive;
    } else {
      error('لم يتم العثور على المهارة');
      router.push('/skills');
    }
  } catch (err) {
    error('حدث خطأ أثناء تحميل بيانات المهارة');
    console.error('خطأ في تحميل المهارة:', err);
    router.push('/skills');
  } finally {
